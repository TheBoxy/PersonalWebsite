...
export default function ProjectsPage() {
  ...
  return (
    <div className="bg-black text-green-400 font-mono h-full overflow-hidden border-2 border-green-400 shadow-2xl shadow-green-400/50 relative">
      {/* CRT Screen Effect */}
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-2">
              <div className="text-green-400">
                <span className="text-cyan-300">root@kevinmartinez:~$</span> ls -l projects/
              </div>
              <button 
              ...
              >
                ...
                <div className="space-y-2 mb-4">
                  <div className="text-green-400/70 text-sm">
                    <span className="text-cyan-300">Handle:</span> [{project.handle}]
                  </div>
                  <div className="text-green-400/70 text-sm">
                    <span className="text-cyan-300">Type:</span> {project.type.replace('_', ' ')}
                  </div>
                </div>
